...
//Code is from here: https://bitbucket.org/jamesy012/opengl-test
...
public:
	Font(const char* const a_FileLocation, void* a_manager);
	~Font();

	void draw(const char* const a_Letters,int const a_X, int const a_Y, Shader* shaderProg, float const a_Scale = 1.0f, glm::vec3 a_Color = glm::vec3(1.0f,1.0f,1.0f));
